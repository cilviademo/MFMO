...
```
branch    main
commit    c29d3150746d42db44e2e5db8ec536bcfd7130bc
...
c29d3150746d42db44e2e5db8ec536bcfd7130bc` from a session that can, or from the
...
commit's hash. `c29d315` is the commit the artifact was **built from** and is
