...
```
branch    main
commit    b4c272de2ca2dc9786700a238bef2c891987a9b9
...
b4c272de2ca2dc9786700a238bef2c891987a9b9` from a session that can, or from the
...
commit's hash. `b4c272d` is the commit the artifact was **built from** and is
